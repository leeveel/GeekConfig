...
namespace Formatters.Data.Containers
{
    public sealed class t_monsterBeanDeserializeProxyFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Data.Containers.t_monsterBeanDeserializeProxy>
    {
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Data.Containers.t_monsterBeanDeserializeProxy value, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::System.Collections.Generic.List<global::Data.Beans.t_monsterBean>>(formatterResolver).Serialize(ref writer, value.datas, options);
        }
            ...
            for (int i = 0; i < length; i++)
            {
                switch (i)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        ____result.datas = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::System.Collections.Generic.List<global::Data.Beans.t_monsterBean>>(formatterResolver).Deserialize(ref reader, options);
                        break;
                    default:
                        reader.Skip();
                        break;
